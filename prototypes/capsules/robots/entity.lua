...
data:extend(
{
  ...
  },
  {
    ...
    subgroup="dytech-combat-capsules",
    order="c",
    max_health = (Health.Tier1*Capsules.Stationary_Extra_Factor),
	resistances = Resistances.Tier4,
    collision_box = {{0, 0}, {0, 0}},
  ...
  },
  {
    ...
    subgroup="dytech-combat-capsules",
    order="c",
    max_health = (Health.Tier2*Capsules.Stationary_Extra_Factor),
	resistances = Resistances.Tier5,
    collision_box = {{0, 0}, {0, 0}},
    selection_box = {{-0.5, -1.5}, {0.5, -0.5}},
    distance_per_frame = 0.13,
  ...
  },
  {
    ...
    subgroup="dytech-combat-capsules",
    order="c",
    max_health = (Health.Tier3*Capsules.Stationary_Extra_Factor),
	resistances = Resistances.Tier6,
    collision_box = {{0, 0}, {0, 0}},
    selection_box = {{-0.5, -1.5}, {0.5, -0.5}},
    distance_per_frame = 0.13,
