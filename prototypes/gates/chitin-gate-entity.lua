...
{
  {
    ...
    minable = {hardness = 0.2, mining_time = 0.5, result = "chitin-wall-gate"},
    max_health = (Health.Tier5*0.75),
    ...
    vertical_animation = vertical_animation_Tint(ChitinWall),
    horizontal_animation = horizontal_animation_Tint(ChitinWall),
    vertical_base = vertical_base(),
    horizontal_rail_animation_left = horizontal_rail_animation_left_Tint(ChitinWall),
    horizontal_rail_animation_right = horizontal_rail_animation_right_Tint(ChitinWall),
    vertical_rail_animation_left = vertical_rail_animation_left_Tint(ChitinWall),
    vertical_rail_animation_right = vertical_rail_animation_right_Tint(ChitinWall),
    ...
    wall_patch = wall_patch_Tint(ChitinWall),
    wall_diode_green =
    {
