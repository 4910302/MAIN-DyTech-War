...
--[[ Equipment ]]--
-- NOTE: These can add up to be quite OP if you get enough!!
Config.BatteryEquipment = true
Config.ShieldEquipment = true
Config.ExoEquipment = true
Config.FusionEquipment = true
Config.LaserEquipment = true
Config.RoboEquipment = true
Config.SolarEquipment = true

-- NOTE: several Equipments REQUIRES you to also have the Machine portion of Dytech enabled!!!!
...
Config.FlameThrowerTurret = false
